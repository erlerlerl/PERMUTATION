...
void RowRenderer::setup(int size, float brightness) {
    this->width = size;
    this->height = size;
    //this->reader = &reader;
...
std::vector<float> RowRenderer::adjustAudioData(float r, float g, float b) {
...
void RowRenderer::updateData(std::vector<float> & audioData){
